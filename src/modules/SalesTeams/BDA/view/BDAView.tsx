...
const BDAView = ({ staffId }: Props) => {
  ...
  {/* Right section */}
  <div className="col-span-12 sm:col-span-4 rounded-xl bg-cover" style={{ backgroundImage: `url(${backGroundView})` }}>
    <div className="w-full h-fit p-4  rounded-xl">
      <div className="flex">
      ...
      <div className="flex flex-col mt-6 p-3 h-full">
        ...
        <div className="flex gap-8 sm:ms-6 my-8 space-x-8">
          <div>
        ...
        <div className="flex space-x-4 sm:space-x-10 bottom-0 ">
          {/* Profile actions */}
        ...
        <div className="flex space-x-6 sm:space-x-14 bottom-0 mt-4 sm:ms-16 ms-6">
      ...
      <Modal open={isModalOpen.editBda} onClose={() => handleModalToggle()} className="w-[70%] max-sm:w-[90%] max-md:w-[70%] max-lg:w-[80%] max-sm:h-[600px] sm:h-[600px] md:h-[700px]  max-sm:overflow-auto">
        <BDAForm editId={iId} onClose={() => handleModalToggle()} />
      </Modal>

      <Modal align="right"  open={isModalOpen.awards} onClose={() => handleModalToggle()}  className="w-[25%] max-sm:w-[90%] max-md:w-[70%] max-lg:w-[35%] mx-auto ">
      ...
      <Modal open={isModalOpen.commission} onClose={() => handleModalToggle()} className="w-[45%] max-sm:w-[90%] max-md:w-[70%] ">
